...
export default function StableCard({ stable }) {
  const hasLatLng = typeof stable?.lat === "number" && typeof stable?.lng === "number";
    ...
    <div className="ss-stable-row">
      <div className="ss-stable-left">
        ...
        <div className="ss-stable-meta">
          <div className="ss-stable-name">{stable?.name ?? "Stable"}</div>
          <div className="ss-stable-tags">
            {stable?.offers?.includes("Lessons") && <TagPill>Lessons</TagPill>}
            {stable?.offers?.includes("Boarding") && <TagPill>Boarding</TagPill>}
          </div>
        </div>
      </div>

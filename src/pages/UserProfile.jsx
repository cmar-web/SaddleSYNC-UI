...
export default function Profile() {
  ...
  // placeholder for future bookings data 4 now
          ...
          <div className="profile-main">
            <div className="profile-container">
              ...
              <div className="grid2">
                ...
                <section className="card">
                  ...
                  <form onSubmit={onSave} className="profile-form">
                    ...
                    <div className="actions-right">
                      <button className="btn-brown" disabled={saving}>
                ...
                {/* my stables if stableowner */}
                {form.StableOwner && (
                  <section className="card">
                    <div className="section-head">
                      <h2 className="section-title">My Stables</h2>
                      <Link to="/stableSignUp" className="btn-ghost">
                        + Add stable
                      </Link>
                    </div>
                    ...
                    {stables.length === 0 ? (
                      <EmptyState
                        ...
                        cta={
                          <Link to="/stableSignUp" className="btn-brown">
                            Create stable
                          </Link>
                        }
                      />
              ...
              <section className="card">
                ...
                {horses.length === 0 ? (
                  <EmptyState
                    ...
                    cta={
                      <Link to="/createHorse" className="btn-brown">
                        Add horse
                      </Link>
                    }
                  />
                      ...
                      >
                        ...
                        <div className="horse-body">
                          ...
                          <div className="horse-sub">
                            {h.Breed ? h.Breed : "—"}{" "}
                            {h.DOB ? `• DOB: ${formatDate(h.DOB)}` : ""}
                          </div>
                        </div>
                        <div className="list-actions">
                          <Link
                            to={`/horses/${h.HorseID ?? h.id}`}
                            className="btn-ghost"
                          >
                            Open
                          </Link>
              ...
              {upcomingBookings.length === 0 ? (
                <div className="sidebar-empty">
                  <p className="sidebar-empty-title">
                    No upcoming lessons or boarding yet
                  </p>
                  <p className="sidebar-empty-body">
                    When you book lessons or boarding, they&apos;ll appear here
                    with dates, times, and locations.
                  </p>
                  <div className="sidebar-cta">
                    <Link to="/search" className="btn-brown">
                      Find services
                    </Link>
                    <Link to="/services/history" className="btn-ghost">
                      View past services
                    </Link>
                  </div>
                </div>
                ...
                <>
                    ...
                    {upcomingBookings.map((b) => (
                      <li key={b.id} className="sidebar-item">
                        ...
                        <div className="sidebar-main">
                          <div className="sidebar-title">{b.title}</div>
                  ...
                  <div className="sidebar-cta">
                    <Link to="/services/upcoming" className="btn-ghost">
                      View all upcoming
                    </Link>
                    <Link to="/services/history" className="btn-ghost">
                      View past services
